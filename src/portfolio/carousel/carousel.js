...
class Carousel extends Component {
  ...
  render() {
    ...
    const portfolioItemStyle = {
      marginLeft: 'calc(50% - 98.5px)', border: 1, borderColor: 'rgba(52,71,89,0.05)', borderStyle: 'solid', backgroundColor: '#FFFFFF', width: 175, height: 0, boxShadow: '2px 3px 3px rgba(52,71,89,0.15)',
    };
    const portfolioItems = _.map(portfolio, (item) => {
      const imageStyle = {
        height: '90%', width: '90%', margin: 'auto', marginLeft: '5%',
      };
      const descriptionStyle = {
        bottom: '4px', textAlign: 'center', margin: '0px', marginLeft: '5px', width: 'calc(100% - 5px)',
      };
